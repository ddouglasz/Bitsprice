...
function (_React$Component) {
  ...
  _createClass(Prices, [{
    ...
    value: function render() {
      ...
      if (this.state.currency === 'USD') {} else if (this.state.currency === 'GDP') {} else if (this.state.currency === 'EUR') {}
...
//# sourceMappingURL=index.js.e1c1a6317948d7ab9486.hot-update.js.map