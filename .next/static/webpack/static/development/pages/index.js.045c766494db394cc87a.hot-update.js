...
function (_React$Component) {
  ...
  _createClass(Prices, [{
    ...
    value: function render() {
      ...
      if (this.state.currency === 'USD') {} else if (this.state.currency === 'USD') {} else if (this.state.currency === 'USD') return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        __source: {
...
//# sourceMappingURL=index.js.045c766494db394cc87a.hot-update.js.map