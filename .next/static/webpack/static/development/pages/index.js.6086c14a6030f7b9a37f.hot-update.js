...
function (_React$Component) {
  ...
  _createClass(Prices, [{
    ...
    value: function render() {
      ...
      if (this.state.currency === 'USD') {} else if (this.state.currency === 'GDP') {} else if (this.state.currency === 'USD') {}
...
//# sourceMappingURL=index.js.6086c14a6030f7b9a37f.hot-update.js.map